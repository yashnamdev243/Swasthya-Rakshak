...
const DoctorManage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3000/api/doctors', formData, {
                headers: {
    ...
    return (
        <Layout>
            <div className="doctor-list-container">
                ...
                <Modal show={showAddDoctorForm} onHide={() => setShowAddDoctorForm(false)}>
                    ...
                    <Modal.Body>
                        <Form onSubmit={handleSubmit}>
                            ...
                            <div className="d-flex justify-content-between" style={{gap:"10px"}}>
                                ...
                                <Button variant="secondary" onClick={() => setShowAddDoctorForm(false)} className="btn-cancel">
                                    Cancel
                                </Button>
                            </div>
                        </Form>
