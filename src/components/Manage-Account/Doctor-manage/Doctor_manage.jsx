...
import Skeleton from "react-loading-skeleton"; // Import Skeleton
import "react-loading-skeleton/dist/skeleton.css"; // Import skeleton CSS
import "./DoctorManage.css"; // External CSS
...
const DoctorManage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setDoctorsData([...doctorsData, response.data]);
      setFilteredDoctors([...doctorsData, response.data]); // Update filteredDoctors
      setShowAddDoctorForm(false); // Close the form
    } catch (error) {
      console.error("Error adding doctor:", error);
    }
  ...
  const handleSearchChange = (e) => {
    ...
    if (value === "") {
      setFilteredDoctors(doctorsData); // Show all doctors if search is empty
    } else {
      setFilteredDoctors(
