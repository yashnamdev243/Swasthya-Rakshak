...
import "./Dentist.css"; // Importing the CSS file
    ...
    useEffect(() => {
        const fetchDoctorsData = async () => {
            try {
                ...
                // Filter the doctors for Dentists only
                const dentistDoctors = response.data.filter(
                    (doctor) => doctor.specialization === "Dentist"
                );
                setFilteredDoctors(dentistDoctors); // Update the filtered state with Dentist doctors
            } catch (error) {
