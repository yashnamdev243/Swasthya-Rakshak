...
import "./Cardilologist.css"; // Importing the CSS file
  ...
  useEffect(() => {
    const fetchDoctorsData = async () => {
      try {
        ...
        // Filter the doctors for Cardiologists only
        const cardiologists = response.data.filter(
          (doctor) => doctor.specialization === "Cardiologist"
        );
        setFilteredDoctors(cardiologists); // Update the filtered state with Cardiologists
      } catch (error) {
